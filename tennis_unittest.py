...
def play_game_by_setting_score(TennisGame, p1Points, p2Points, p1Name, p2Name):
    game = TennisGame(p1Name, p2Name)
    game.set_player_1_score(p1Points)
    game.set_player_2_score(p2Points)
    return game
...
class TestTennis(unittest.TestCase):
    ...
    def test_Score_Game2(self):
        for testcase in test_cases:
            ...
            # Play game by setting score
            game = play_game_by_setting_score(TennisGame2, p1Points, p2Points,
                                              p1Name, p2Name)
            self.assertEqual(score, game.score())
